...
export var MOUSE_CLICK_BUTTONS = {
    ALL: -1,
    LEFT: 0,
    MIDDLE: 1,
    RIGHT: 2,
...
var JoystickController = /** @class */ (function () {
    ...
    function JoystickController(options, onMove) {
        ...
        this.addEventListeners = function () {
            ...
            if (_this.options.dynamicPosition) {
                ...
                if (_this.options.hideContextMenu) {
                    target.addEventListener("contextmenu", function (e) { return e.preventDefault(); });
        ...
        this.dynamicPositioningMouse = function (e) {
            if (_this.identifier !== null)
                return;
            if (_this.mouseButton !== -1 && e.button !== _this.mouseButton)
                return;
        ...
        this.removeDynamicPositioning = function (e) {
            ...
            if (e.type === "touchend") {
                ...
                if (_this.identifier !== identifier)
                    return;
            }
            else if (_this.mouseButton !== -1 &&
                e.button !== _this.mouseButton)
                return;
        ...
        this.updateCoordinates = function (x, y) {
            ...
            var adjustedDistance = _this.distance > _this.options.maxRange
                ? _this.options.maxRange
                : _this.distance;
        ...
        this.onStartEvent = function (event, addIdentifier) {
            if (addIdentifier === void 0) { addIdentifier = true; }
            if (event.type === "mousedown") {
                if (_this.mouseButton !== -1 &&
                    event.button !== _this.mouseButton)
                    return;
        ...
        this.recenterJoystick = function () {
            ...
            _this.centerX =
                _this.controller.getBoundingClientRect().left + _this.options.radius;
            _this.centerY =
                _this.controller.getBoundingClientRect().top + _this.options.radius;
        };
    ...
    JoystickController.prototype.validate = function () {
        var _this = this;
        if (window[JOYSTICK_WINDOW_ACTIVE] &&
            window[JOYSTICK_WINDOW_ACTIVE].length > 0 &&
            window[JOYSTICK_WINDOW_ACTIVE].some(function (j) {
                return j.options.dynamicPosition &&
                    (j.options.dynamicPositionTarget || document) ===
                        (_this.options.dynamicPositionTarget || document);
            })) {
    ...
    JoystickController.prototype.destroy = function () {
        ...
        if (Array.isArray(window[JOYSTICK_WINDOW_ACTIVE]))
            window[JOYSTICK_WINDOW_ACTIVE] = window[JOYSTICK_WINDOW_ACTIVE].filter(function (joystick) { return joystick !== _this; });
    };
    return JoystickController;
}());
export default JoystickController;
//# sourceMappingURL=joystick-controller.js.map